...
module ProxyAPI
  class ExternalIpam < ProxyAPI::Resource
    ...
    #         2. subnet:           The IPv4 or IPv6 subnet CIDR. (Examples: IPv4 - "100.10.10.0/24", IPv6 - "2001:db8:abcd:12::/124")
    #         3. mac:              The mac address of the interface obtaining the IP address for
    #         4. group(optional):  The group in External IPAM that the subnet belongs to(e.g. This would be "Section" in phpIPAM)
    #
    # Responses:
    ...
    #
    # Params: 1. provider:         The external IPAM provider(e.g. "phpipam", "netbox")
    #         2. ip:               IP address to be added
    #         3. subnet:           The IPv4 or IPv6 subnet CIDR. (Examples: IPv4 - "100.10.10.0/24",
    #                              IPv6 - "2001:db8:abcd:12::/124")
    #         4. group(optional):  The name of the External IPAM group containing the subnet.
    #
    ...
    #     {"error": "No groups found in External IPAM"}
    ...
    # Get a group from External IPAM. A group is a logical grouping of subnets/ips (i.e. 'Section' in
    # in phpIPAM, or 'Tenant' in Netbox)
    #
    # Params:   1. provider:  The external IPAM provider(e.g. "phpipam", "netbox")
    ...
    #
    # Inputs: 1. provider:         The external IPAM provider(e.g. "phpipam", "netbox")
    #         2. ip:               IP address to be freed up
    #         3. subnet:           The IPv4 or IPv6 subnet CIDR. (Examples: IPv4 - "100.10.10.0/24",
    #                              IPv6 - "2001:db8:abcd:12::/124")
    #         4. group(optional):  The name of the External IPAM group containing the subnet.
    #
    ...
    # Inputs: 1. provider:  The external IPAM provider(e.g. "phpipam", "netbox")
    #         2. subnet:    The IPv4 or IPv6 subnet CIDR. (Examples: IPv4 - "100.10.10.0/24", IPv6 - "2001:db8:abcd:12::/124")
    #         3. group:     The name of the External IPAM group containing the subnet.
    #
    # Proxy responses:
    #   Response if exists:
    #     {"subnet": "172.55.55.0", "mask": "24", "description": "My subnet"}
